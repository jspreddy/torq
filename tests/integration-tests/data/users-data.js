export default [
    ...
    },
    {
        ...
        sk: 'role:marketing',
        name: 'marketing',
        privilege: 'marketing-access',
    },
    {
        pk: 'suresh@example.com',
        sk: 'role:operations',
        name: 'operations',
        privilege: 'operations-access',
    },
    {
        pk: 'suresh@example.com',
        sk: 'role:sales',
        name: 'sales',
        privilege: 'sales-access',
    ...
    },
    {
        ...
        sk: 'role:support',
        name: 'support',
        privilege: 'support-access',
        deleted_at: '2024-03-15T00:00:00.000Z',
    },
    {
        pk: 'suresh@example.com',
        sk: 'role:development',
        name: 'development',
        privilege: 'development-access',
        deleted_at: '2024-01-20T00:00:00.000Z',
    },
    {
        pk: 'suresh@example.com',
        sk: 'role:qa',
    ...
    {
        pk: 'mahesh@example.com',
        sk: 'order:2024-02:f3e8d1',
        o_id: 'f3e8d1',
        orderDate: '2024-02-03T15:45:00.000Z',
    ...
    {
        pk: 'mahesh@example.com',
        sk: 'order:2024-03:k5m7n9',
        o_id: 'k5m7n9',
        orderDate: '2024-03-21T09:15:00.000Z',
    ...
    {
        pk: 'mahesh@example.com',
        sk: 'order:2024-04:p2q4r6',
        o_id: 'p2q4r6',
        orderDate: '2024-04-05T14:20:00.000Z',
    ...
    {
        pk: 'mahesh@example.com',
        sk: 'order:2024-05:x8y1z3',
        o_id: 'x8y1z3',
        orderDate: '2024-05-01T11:00:00.000Z',
    ...
    {
        pk: 'ramesh@example.com',
        sk: 'role:analytics-write',
        name: 'analytics-write',
        privilege: 'analytics-write',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:analytics',
        name: 'analytics',
        privilege: 'analytics-read',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:basic',
    ...
    {
        pk: 'ramesh@example.com',
        sk: 'role:compliance-write',
        name: 'compliance-write',
        privilege: 'compliance-write',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:compliance',
        name: 'compliance',
        privilege: 'compliance-read',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:engineering-write',
        name: 'engineering-write',
        privilege: 'engineering-write',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:engineering',
        name: 'engineering',
        privilege: 'engineering-read',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:finance-write',
        name: 'finance-write',
    ...
    { pk: 'ramesh@example.com', sk: 'role:hr', name: 'hr', privilege: 'hr-read' },
    {
        ...
        sk: 'role:legal-write',
        name: 'legal-write',
        privilege: 'legal-write',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:legal',
        name: 'legal',
        privilege: 'legal-read',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:marketing-write',
        name: 'marketing-write',
        privilege: 'marketing-write',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:marketing',
        name: 'marketing',
        privilege: 'marketing-read',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:operations-write',
        name: 'operations-write',
        privilege: 'operations-write',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:operations',
        name: 'operations',
        privilege: 'operations-read',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:product-write',
        name: 'product-write',
        privilege: 'product-write',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:product',
    ...
    {
        pk: 'ramesh@example.com',
        sk: 'role:quality-write',
        name: 'quality-write',
        privilege: 'quality-write',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:quality',
        name: 'quality',
        privilege: 'quality-read',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:reports',
    ...
    },
    {
        ...
        name: 'research-write',
        privilege: 'research-write',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:research',
        name: 'research',
        privilege: 'research-read',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:sales-write',
        name: 'sales-write',
        privilege: 'sales-write',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:sales',
        name: 'sales',
        privilege: 'sales-read',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:security-write',
        name: 'security-write',
        privilege: 'security-write',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:security',
        name: 'security',
        privilege: 'security-read',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:super-admin',
    ...
    {
        pk: 'ramesh@example.com',
        sk: 'role:support-write',
        name: 'support-write',
        privilege: 'support-write',
    },
    {
        pk: 'ramesh@example.com',
        sk: 'role:support',
        name: 'support',
        privilege: 'support-read',
    },

    {
        pk: 'priya@example.com',
        sk: 'user',
        firstName: 'priya',
        lastName: 'sharma',
        age: 28,
